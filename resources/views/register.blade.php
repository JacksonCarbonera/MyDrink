...
<body>
                ...
                <div class="card mb-3 item" style="max-width: 540px;">
                    <form>
                        ...
                        <div class="card-actions">
                            <button class="card-logar" type='submit'>Registrar</button>
                        </div>
                    </form>
    ...
    <h1>CRIAR CONTA</h1>
    <h3>Preencha todas as informações abaixo: </h3>
    <form method='post' action='{{route('registrar')}}'>
        @csrf
        <div class="form-group">
            <x-Input name='name' text='Nome Completo' placeholder="Seu nome"/>
            {{-- <label for="exemplename">Nome Completo</label>
            <input type="text" class="form-control" id="exemplename" name='name' placeholder="Nome Completo"> --}}
        </div>
        <div class="form-group">

            <x-Input name='email' text='Email' type='email'/>

        </div>
        <div class="form-group">

            <x-Input name='confirm_email' text='Confirmação do Email' type='email'/>

        </div>
        <div class="form-group">
            <x-Input name='telefone' text='Telefone'/>

        </div>
        <div class="form-group">

            <x-Input name='cpf' text='CPF'/>
        ...
        <div class="form-group">
           ...
           <x-Input name='confirm_password' text='Confirmação da Senha' type='password'/>
        
        </div>
        <div class="card-actions">
            <button class="card-logar" type='submit'>Criar Conta</button>
        </div>
    </form>
