...
<body>
    ...
    <form>
        ...
        <div class="form-group">
            <label for="pag">Metodo Pagamento</label>
            <input type="text" class="form-control" id="pag" placeholder="Metodo Pagamento">
        </div>
        <div class="form-group">
            <label for="preco">Preço</label>
            <input type="number" class="form-control" id="preco" aria-describedby="Preço"
                placeholder="Preço">
        </div>
        <div class="form-group">
