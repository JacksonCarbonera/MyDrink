...
<body>
    ...
    <main>
        <div id="a" class='card-item'>
            <img src="./b.jpg" alt="">
            <p class='card-title'>Kit Opala</p>
            <p class='money card-price'>5</p>
            <p>no pix ou boleto</p>
            <p class='card-condition-payment'>5x de <span class="money">5</span> sem juros</p>
            <div class="card-actions">
        ...
        <div class='card-item'>
            ...
            <div class="card-actions">
                <div class="card-quantificator">
                    ...
                    <span class="card-quantitity">1</span>
